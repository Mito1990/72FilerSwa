...
const handleGroup = (group) =>{
  ...
  <div name="main" className='h-screen w-screen bg-slate-400 flex flex-row relative p-4'>
        ...
        {(getCurrentUrl()==="share") ? (
          <div name="Panel" className='mt-12 flex flex-row m-4 w-1/6 justify-center items-start h-5/6 rounded-md overflow-auto'>
          ...
          :
          (
            <div name="Panel" className='bg-slate-500 mt-12 flex flex-row m-4 w-1/6 justify-center items-start h-5/6 rounded-md shadow-2xl overflow-auto'>
